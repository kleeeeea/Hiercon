...
import pickle
import logging
from Hiercon.econ.embedding import to_concept_natural, re_concept_tagged, to_concept_gensim, to_concept_natural_lower
...
for l in open('/disk/home/klee/workspace_remote/Hiercon/candidate_generation/AutoPhrase/data/EN/wiki_quality.txt'):
    concept = l.strip()
